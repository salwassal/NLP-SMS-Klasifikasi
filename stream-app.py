...
# Load save model
model_fraud = pickle.load(open('dataset/model_fraud.sav','rb'))

tfidf = TfidfVectorizer
loaded_vec = TfidfVectorizer(decode_error="replace", vocabulary=set(pickle.load(open("dataset/new_selected_features_tf-idf.sav", "rb"))))
